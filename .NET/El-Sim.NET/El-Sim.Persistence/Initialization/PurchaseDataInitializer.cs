using El_Sim.Domain.PhoneNumbers;
...
public class PurchaseDataInitializer
{
    ...
    public async Task InitializeAsync()
    {
        ...
        foreach (var prefix in PhoneNumberRules.BasicPrefixes)
        {
            await EnsureSetting(PhoneNumberRules.SettingKey(prefix, false), "5");
            await EnsureSetting(PhoneNumberRules.CurrencySettingKey(prefix, false), "AZN");
        }

        await EnsureSetting(PhoneNumberRules.SettingKey(PhoneNumberRules.GlobalPrefix, true), "10");
        await EnsureSetting(PhoneNumberRules.CurrencySettingKey(PhoneNumberRules.GlobalPrefix, true), "AZN");
