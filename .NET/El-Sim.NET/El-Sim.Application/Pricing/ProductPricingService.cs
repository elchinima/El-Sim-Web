namespace El_Sim.Application.Pricing;

public class ProductPricingService
{
    public const decimal ConversionCommissionRate = 0.03m;

    public async Task<ProductPriceCalculation> CalculateAsync(Product product, IExchangeRateService exchangeRateService, CancellationToken cancellationToken = default)
    {
...
{
    Task<ExchangeRateResult> GetUsdToAznAsync(CancellationToken cancellationToken = default);
}

public record ExchangeRateResult(decimal UsdToAzn, DateTime Date, bool IsFallback);
